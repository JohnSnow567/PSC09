...
namespace PSC09
{
    public partial class frmVenFactura : Form
    {
        public string var1;
        public string var2;
        public string var3;
        public Boolean existeVar;
        public frmVenFactura()
        {
            InitializeComponent();
            EstiloDataGridView();
        }

        private void frmVenFactura_Load(object sender, EventArgs e)
        {
            this.KeyPreview = true;
        }

        private void frmVenFactura_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void BuscarData()
        {
            ...
            while (rcd.Read())
            {
                ...
                dgv[0, xRows].Value = rcd["FACTURA"].ToString();
                dgv[1, xRows].Value = rcd["FECHA"].ToString();
                dgv[2, xRows].Value = rcd["SUBTOTAL"].ToString();
                dgv[3, xRows].Value = rcd["IMPUESTO"].ToString();
                dgv[4, xRows].Value = rcd["MONTOFACTURADO"].ToString();
